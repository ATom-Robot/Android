...
public class FangxiangView extends View {
    private static final String TAG = "FangxiangView";
    ...
    public FangxiangView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FangxiangView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (listener != null) {
            ...
            if (actionMask == MotionEvent.ACTION_DOWN) {
                buttonColor = SlowHui;
                listener.setOnTouchListener(getXValue(), getYValue(), false);
                return true;
            } else if (actionMask == MotionEvent.ACTION_MOVE) {
                buttonColor = SlowHui;
                listener.setOnMovedListener(getXValue(), getYValue(), false);
                return true;
            }
            //归中
                ...
                lastX = 0;
                lastY = 0;
                listener.setOnReleaseListener(0, 0, false);
                return true;
            }
        }
        return false;
